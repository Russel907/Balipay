...
def _parse_dates(request):
    ...
    if not start_s and not end_s:
        ...
        if start is None:
            return None, None, None, "Invalid startDate/fromDate format."
        if end is None:
            return None, None, None, "Invalid endDate/toDate format."

    if start > end:
        return None, None, None, "startDate/fromDate must be before endDate/toDate."
...
class ForgotPasswordView(APIView):
    def post(self, request):
        ...
        return Response({"message": f"OTP sent successfully", "otp": otp})
